...
class AdminInviteInstructorView(APIView):
    ...
    def post(self, request):
        ...
        member_id = generate_user_id("instructor")
...
class AdminInviteTraineeView(APIView):
    ...
    def post(self, request):
        ...
        member_id = generate_user_id("trainee")
...
class AdminCourseListCreateView(APIView):
    ...
    def post(self, request):
        ...
        # In-platform notification for the assigned instructor
        try:
            from notifications.utils import notify_instructor_course_assigned
            notify_instructor_course_assigned(course.instructor, course)
        except Exception:
            pass
        ...
        if course.status == "Published" and course.instructor and course.instructor.email:
            instructor_name = (
            ...
            html_body = build_course_assignment_email_html(
                ...
                open_date=course.open_date or "TBD",
...
class AdminCourseDetailView(APIView):
    ...
    def get_object(self, course_id):
        return Course.objects.select_related("instructor").get(id=course_id)
...
class AdminDashboardSummaryView(APIView):
    ...
    def get(self, request):
        ...
        published_courses_count = Course.objects.filter(status="Published").count()
